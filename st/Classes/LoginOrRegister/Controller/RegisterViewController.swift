...
class RegisterViewController: UIViewController, UITextFieldDelegate, SingleKeyBoardDelegate {
    ...
    func setup() {
        ...
        // 重复密码field
        repasswordField = setupTextField(placeHolder: "确认密码", tintColor: .black, textColor: .black, backgroundColor: .white, keyboardType: .default, font: 17, leftView: "password_con")
        ...
        // 密码field
        passwordField = setupTextField(placeHolder: "密码", tintColor: .black, textColor: .black, backgroundColor: .white, keyboardType: .default, font: 17, leftView: "password")
        ...
        confirmBtnClick.addTarget(self, action: #selector(registerBtnClick), for: .touchUpInside)
...
//        }
        ...
        let params = NSMutableDictionary()
        params["method"]   = Api.registerMethod
        params["account"]  = mobileField.text
...
//        let keyboardY = (info[UIKeyboardFrameEndUserInfoKey] as! NSValue).cgRectValue.size.height
//        let offsetX = confirmBtn.y - keyboardY - 120
//
//        print(view.y)
//        if view.y == 64 {
