...
class HomeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func setupScrollView() {
        ...
        let scrollView = UIScrollView(frame: CGRect(x:0, y:y, width:Constant.screenW, height:Constant.screenH - y))
...
//        tableView.frame = CGRect(x:30, y:275, width:Constant.screenW - 60, height:327)
    ...
    func setupHeadView() {
        ...
        let headView = UIView()
        headView.frame = CGRect(x: 0, y: y, width: Constant.screenW, height: 64)
